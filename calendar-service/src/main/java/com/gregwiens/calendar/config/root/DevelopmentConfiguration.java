...
import com.gregwiens.calendar.app.init.TestDataInitializer;
...
public class DevelopmentConfiguration {
    ...
    public DriverManagerDataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/time-tracker?loglevel=0");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DriverManagerDataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[]{"com.gregwiens.calendar.app.model"});
